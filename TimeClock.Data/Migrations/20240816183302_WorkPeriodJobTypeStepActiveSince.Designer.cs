...
namespace TimeClock.Data.Migrations
{
    ...
    [Migration("20240816183302_WorkPeriodJobTypeStepActiveSince")]
    partial class WorkPeriodJobTypeStepActiveSince
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TimeClock.Data.Models.WorkPeriodJobTypeStep", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.Property<DateTime>("ActiveSince")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("datetime2")
                        .HasComputedColumnSql("[timeclock].[WorkPeriodJobTypeStepActiveSince]([PunchEntryId], [EquipmentsToUserId], [ActivatedOn])", false);
                    ...
                    b.Property<Guid?>("EquipmentsToUserId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("WorkPeriodJobTypeSteps", "timeclock", t =>
                        {
                            t.HasTrigger("Enable_Nondeterminate_Computed_Column")
                                .HasDatabaseName("Enable_Nondeterminate_Computed_Column1");
                        });
            ...
            modelBuilder.Entity("TimeClock.Data.Models.WorkPeriodJobTypeStep", b =>
                {
                    ...
                    b.HasOne("TimeClock.Data.Models.EquipmentsToUser", "EquipmentsToUser")
                        .WithMany()
                        .HasForeignKey("EquipmentsToUserId")
                    ...
                    b.HasOne("TimeClock.Data.Models.WorkPeriod", "WorkPeriod")
                        .WithMany("WorkPeriodJobTypeSteps")
                        .HasForeignKey("WorkPeriodId")
                        .IsRequired()
            ...
            modelBuilder.Entity("TimeClock.Data.Models.WorkPeriod", b =>
                {
                    ...
                    b.Navigation("WorkPeriodJobTypeSteps");
